...
function RecordAllProposals(props){
    ...
    <div
        ...
        <div className="p-5">
            ...
            <p className="mb-3 font-normal text-gray-400 dark:text-gray-700">
                Title : {props.record.title}<br />
                Goal : {props.record.goal}<br />
                Scope : {props.record.scope}<br />
                Advantages : {props.record.advantages}<br />
                Description : {props.record.description}<br />
                Upload Pdf : {props.record.pdf}<br />
