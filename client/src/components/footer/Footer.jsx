      ...
      <div className="footer-content-column">
        <div className="footer-logo">
          <a className="footer-logo-link" href="#">
            ...
            <h1 className="text-slate-900">MUNICIPAL COUNCIL</h1>
          </a>
        </div>
        <div className="footer-menu">
          <h2 className="footer-menu-name"> VISION</h2>
          <p className="text-slate-900">
            
The Municipal Council Service Management System aims to simplify access to services, encourage citizen participation, and improve local community management.
          </p>
        </div>
      </div>
      <div className="footer-content-column">
      ...
      <div className="footer-content-column">
        <div className="footer-menu">
          <h2 className="footer-menu-name"> Payments</h2>
      ...
      <div className="footer-copyright-wrapper">
        <p className="footer-copyright-text">
          <a className="footer-copyright-link" href="#" target="_self">
            {" "}
            ©2023. | Designed By: SLIIT Project | All rights reserved.{" "}
          </a>
        </p>
      </div>
    </div>
