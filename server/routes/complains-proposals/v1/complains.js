...
router.post('/v1', auth.requireAuth, auth.checkUser, upload.single('image'), complain.createComplain);
...
router.get('/v1/:id/download', auth.requireAuth, auth.checkUser, complain.downloadPicture);
